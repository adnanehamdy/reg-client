...
INSERT INTO "REG"."GLOBAL_PARAM" VALUES ('mosip.id.validation.identity.phone','mosip.id.validation.identity.phone','^212([6-9]{1})([0-9]{8})$','CONFIGURATION','eng',true,'SYSTEM',current timestamp, 'SYSTEM',current timestamp, false, current timestamp);
